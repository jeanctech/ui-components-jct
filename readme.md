...
Check out [SvelteKit](https://github.com/sveltejs/kit#readme), which is also powered by Vite.js Deploy anywhere with its serverless-first approach and adapt to various platforms, with out of the box support for TypeScript, SCSS, and Less, and easily-added support for mdsvex, GraphQl, PostCss, TailwindCss, and more.
...
Other templates indirectly recommend extensions via the README, but this file allows VsCode to prompt the user to install the recommended extension upon opening the project.
